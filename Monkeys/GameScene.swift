...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createPlayers() {
        ...
        let player2Builing = buildings[2]
        player2.position = CGPoint(x: player2Builing.position.x, y: player2Builing.position.y + ((player2Builing.size.height + player2.size.height)/2))
        addChild(player2)
    }
    func launch(angle angle: Int, velocity: Int) {
        
        var speed = Double(velocity)/10
        ...
        if currentPlayer == 1{
            ...
            banana.position = CGPoint(x: player2
                .position.x + 30, y: player2.position.y + 40)
            banana.physicsBody!.angularVelocity = 20
        ...
        func didBeginContact(contact: SKPhysicsContact) {
            ...
            if let firstNode = firstBody.node {
                if let secondNode = secondBody.node {
                    ...
                    if firstNode.name == "banana" && secondNode.name == "player 2"  {
